...
public class FeaturewisePerformanceModelBuilder
    extends ApproachPerformanceModelBuilder {

  public static final String DIRECTORY =
      Options.DIRECTORY + "/performance-model/java/programs/featurewise";

  public FeaturewisePerformanceModelBuilder(
      String programName, Map<Set<String>, Double> learnedModel) {
  ...
  public PerformanceModel createModel() {
    ...
    PerformanceModel pm = new FeaturewisePerformanceModel(
