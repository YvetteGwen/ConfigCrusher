...
public class Pairwise extends Approach {
  ...
  public Pairwise(String programName) { super(programName); }
  ...
  public Map<Set<String>, Double> getLearnedModel(List<String> options)
    ...
    String dataDir = Evaluation.DIRECTORY + "/" + this.getProgramName() +
                     Approach.DATA_DIR + "/" + Evaluation.PAIR_WISE;
  ...
  getPairwiseEntries(Set<PerformanceEntryStatistic> performanceEntries) {
    Set<Set<String>> allConfigurations =
        this.getConfigurations(performanceEntries);
    Set<Set<String>> pairwiseConfigurations;

    if (this.getFm() == null) {
      pairwiseConfigurations =
          Pairwise.getPairwiseConfigurations(allConfigurations);
    } else {
      pairwiseConfigurations =
          Pairwise.getPairwiseConfigurations(allConfigurations, this.getFm());
    }
  ...
  getPairwiseConfigurations(Set<Set<String>> allConfigurations) {
  ...
  public static Set<Set<String>>
  getPairwiseConfigurations(Collection<String> options) {
    Set<List<String>> pairs = Pairwise.getPairs(options);
