...
public class BFRunningExampleMain extends RunningExampleMain {
  ...
  public static final String BF_RUNNING_EXAMPLE_MAIN =
      BFRunningExampleMain.class.getCanonicalName();

  public BFRunningExampleMain(String programName, String iteration,
                              String[] args) {
