...
public class SPLatDelayElevatorDelayMain extends SPLatDelayMain {
  ...
  public SPLatDelayElevatorDelayMain(String programName) { super(programName); }
  ...
  public Set<Set<String>> getSPLatConfigurations() {
    ...
    List<String> options =
        new ArrayList<>(ElevatorAdapter.getElevatorOptions());
    ...
    if (!fm.isValidProduct(configuration)) {
      throw new RuntimeException(
          "The feature base is not the only required feature");
    }
