...
public class Family {
  ...
  public Family(String programName) { this.programName = programName; }
  ...
  //        Collection<File> files = FileUtils.listFiles(dir, new
  //        String[]{"txt"}, true);
  //
  //        for(File file : files) {
  ...
  //    }
  //
  //    private Map<Set<String>,Double> averageModels(List<Map<Set<String>,
  //    Double>> models) {
  ...
  //    }
  //
  //    private Map<Set<String>, Double> parseMeasurement(File file) throws
  //    IOException {
  //        Map<Set<String>, Double> model = new HashMap<>();
  //
