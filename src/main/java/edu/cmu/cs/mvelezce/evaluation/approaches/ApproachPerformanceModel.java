...
public abstract class ApproachPerformanceModel extends PerformanceModel {
  ...
  protected static Map<Region, Map<Set<String>, Long>> toNanosecondPerformance(
      Map<Region, Map<Set<String>, Double>> regionsToPerformanceTables) {
    ...
    for (Map.Entry<Region, Map<Set<String>, Double>> regionToTable :
      ...
      for (Map.Entry<Set<String>, Double> configToPerformance :
           regionToTable.getValue().entrySet()) {
        long nanoseconds = DefaultPerformanceEntry.toNanoseconds(
            configToPerformance.getValue());
  ...
  public double evaluate(Set<String> configuration) {
    ...
    for (Map.Entry<Region, Map<Set<String>, Double>> entry :
         this.getRegionsToPerformanceTablesHumanReadable().entrySet()) {
      for (Map.Entry<Set<String>, Double> optionsToPerformance :
