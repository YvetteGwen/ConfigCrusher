...
public class FamilyModelBuilder extends BasePerformanceModelBuilder {
  ...
  public static final Set<String> BASE =
      new HashSet<>(Collections.singletonList("BASE"));

  public static final String DIRECTORY =
      Options.DIRECTORY + "/performance-model/java/programs/family";
  ...
  private Map<Set<String>, Double> getModel() throws IOException {
    ...
    Collection<File> files =
        FileUtils.listFiles(dir, new String[] {"txt"}, true);
  ...
  private Map<Set<String>, Double>
  averageModels(List<Map<Set<String>, Double>> models) {
  ...
  //    }
  //    @Override
  //    public void writeToFile(PerformanceModel performanceModel) throws
  //    IOException {
  //        throw new UnsupportedOperationException();
  //    }
  //
