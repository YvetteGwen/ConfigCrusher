...
public class PrinterTransformer extends RegionTransformer {
  ...
  public PrinterTransformer(
      String programName, String directory,
  ...
  public PrinterTransformer(
      String programName, ClassTransformer classTransformer,
      Map<JavaRegion, Set<Set<String>>> regionsToOptionSet)
      throws InvocationTargetException, NoSuchMethodException,
             MalformedURLException, IllegalAccessException {
  ...
  public InsnList getInstructionsStartRegion(JavaRegion javaRegion) {
    ...
    instructionsBeforeRegion.add(new FieldInsnNode(
        Opcodes.GETSTATIC, "java/lang/System", "out", "Ljava/io/PrintStream;"));
    instructionsBeforeRegion.add(
        new LdcInsnNode(this.messageToPrint + " at start of region"));
    instructionsBeforeRegion.add(
        new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "java/io/PrintStream",
  ...
  public InsnList getInstructionsEndRegion(JavaRegion javaRegion) {
    ...
    instructionsAfterRegion.add(new FieldInsnNode(
        Opcodes.GETSTATIC, "java/lang/System", "out", "Ljava/io/PrintStream;"));
    instructionsAfterRegion.add(
        new LdcInsnNode(messageToPrint + " at end of region"));
    instructionsAfterRegion.add(
        new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "java/io/PrintStream",
                           "println", "(Ljava/lang/String;)V", false));
