 ...
 */
public class ConfigCrusherTimerRegionInstrumenter
    extends BaseRegionInstrumenter {

  private String entryPoint;

  public ConfigCrusherTimerRegionInstrumenter(
  ...
  public void instrument()
    ...
    MethodTransformer methodTransformer = new ConfigCrusherTimerTransformer(
        this.getProgramName(), this.entryPoint, this.getClassDir(),
        this.getRegionsToOptionSet());
    methodTransformer.transformMethods();
  }

  @Override
  public void compileFromSource() {
    // We do not compile since other transformation might have occured to make
    // the instrumentation easier
    return;
  }
