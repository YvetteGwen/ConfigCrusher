...
public class Formatter extends CompileInstrumenter {
  ...
  public Formatter(String srcDir, String classDir) { super(srcDir, classDir); }

  @Override
  public void instrument()
      throws NoSuchMethodException, IOException, IllegalAccessException,
             InvocationTargetException {
    // TODO create a list of transformers to execute similar to jimple
    // manipulation

    MethodTransformer transformer =
        new VariableBeforeReturnTransformer(this.getClassDir());
