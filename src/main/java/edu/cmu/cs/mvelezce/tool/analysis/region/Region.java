...
public class Region {
  ...
  public Region(String regionID) { this.regionID = regionID; }

  public Region() { this(UUID.randomUUID().toString()); }
  ...
  public void startTime(long startTime) { this.startTime = startTime; }

  public void endTime() { this.endTime(System.nanoTime()); }

  public void endTime(long endTime) { this.endTime = endTime; }

  @Override
  public String toString() {
    return "Region{"
        + "regionID='" + regionID + '\'' + ", startTime=" + startTime +
