...
public class DecisionAndOptions {
  ...
  public JavaRegion getRegion() { return region; }

  public void setRegion(JavaRegion region) { this.region = region; }

  public Set<Set<String>> getOptions() { return options; }

  public void setOptions(Set<Set<String>> options) { this.options = options; }
}
