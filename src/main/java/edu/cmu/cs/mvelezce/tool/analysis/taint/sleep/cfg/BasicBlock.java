...
/**
 * A BasicBlock in a CFG. It contains an id, a statement, and a list of
 * expressions which are the conditions for this statement to be executed.
 *
...
public class BasicBlock {
   ...
   * @param statement
   */
  public BasicBlock(Statement statement) { this(statement, new ArrayList<>()); }
   ...
   * @param id
   */
  public BasicBlock(String id) { this(id, null, new ArrayList<>()); }

  /**
   * Returns true if the BasicBlock does not contain a statement. This means
   * that it is either the entry or exit BasicBlock fo the CFG.
   *
   * @return
   */
