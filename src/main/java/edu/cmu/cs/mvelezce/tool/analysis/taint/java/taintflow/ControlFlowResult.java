...
public class ControlFlowResult {
  ...
  public ControlFlowResult(String packageName, String className,
                           String methodSignature, int bytecodeIndex,
                           int javaLine, Set<String> options) {
  ...
  public int getBytecodeIndex() { return bytecodeIndex; }
