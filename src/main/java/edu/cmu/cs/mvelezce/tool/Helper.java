...
public class Helper {
  ...
  //    public static void removeSampledConfigurations(String name,
  ...
  //        Set<PerformanceEntryStatistic> performanceEntries =
  ...
  getRandomConfigs(List<String> options, int size,
