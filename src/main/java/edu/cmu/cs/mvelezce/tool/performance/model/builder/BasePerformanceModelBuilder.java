 ...
 */
public abstract class BasePerformanceModelBuilder
    implements PerformanceModelBuilder {

  public static final String DIRECTORY =
      Options.DIRECTORY + "/performance-model/java/programs";
  ...
  public PerformanceModel readFromFile(File file) throws IOException {
    throw new UnsupportedOperationException(
        "Have not figured out how to deserialize a performance model");
    //        ObjectMapper mapper = new ObjectMapper();
    //        PerformanceModel performanceModel = mapper.readValue(file, new
    //        TypeReference<PerformanceModel>() {
    //        });
    //
    //        return performanceModel;
  }
