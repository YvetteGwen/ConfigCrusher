...
public abstract class BaseMethodTransformer implements MethodTransformer {
  ...
  public BaseMethodTransformer(String programName,
  ...
  public void transformMethods(Set<ClassNode> classNodes) throws IOException {
    for (ClassNode classNode : classNodes) {
      ...
      this.classTransformer.writeClass(
          classNode, this.classTransformer.getPath() + "/" + classNode.name);
    }
  }

  public String getProgramName() { return programName; }

  public ClassTransformer getClassTransformer() { return classTransformer; }
}
