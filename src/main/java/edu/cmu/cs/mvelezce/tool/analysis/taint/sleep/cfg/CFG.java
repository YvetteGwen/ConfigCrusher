...
/**
 * A Control Flow Graph built with BasicBlocks. This is build with a
 * pseudo-adjacency list; it has a map of BasicBlocks with a list of BasicBlock
 * representing the edges. It has special entry and exit Basic Blocks to
...
public class CFG {
  ...
  public List<BasicBlock> getPredecessors(BasicBlock basicBlock) {
    ...
    for (Map.Entry<BasicBlock, List<BasicBlock>> entry :
         this.edges.entrySet()) {
