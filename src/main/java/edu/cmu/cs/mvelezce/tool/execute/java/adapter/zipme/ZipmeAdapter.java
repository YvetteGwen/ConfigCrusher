...
public class ZipmeAdapter extends BaseAdapter {
  ...
  public static String[] adaptConfigurationToProgram(
    ...
    String[] sleepConfiguration =
        new String[ZipmeAdapter.CONFIGURATIONS.length];
  ...
  public void execute(Set<String> configuration) {
    String[] argsArray =
        ZipmeAdapter.adaptConfigurationToProgram(configuration);
    ...
    //        BaseAdapter.executeJavaProgram(programName, ZipmeMain.ZIPME_MAIN,
