...
public class FindAdapter extends BaseAdapter {
  ...
  public FindAdapter() { this(null, null, null); }
  ...
  public static List<String> getFindOptions() {
    String[] options = {"ISTYPEDIRECTORY", "ISTYPEFILE",     "ISTYPESYMLINK",
                        "ISTYPEOTHER",     "ISREGEX",        "ISIGNORECASE",
                        "ISTIMENEWER",     "ISTIMEOLDER",    "ISTIMECREATE",
                        "ISTIMEACCESS",    "ISTIMEMODIFIED", "ISPRINT0"};
