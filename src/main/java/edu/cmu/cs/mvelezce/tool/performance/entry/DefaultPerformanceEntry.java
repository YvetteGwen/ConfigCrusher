...
public class DefaultPerformanceEntry implements PerformanceEntry {
  ...
  private Map<Region, Double> regionsToRawPerformanceHumanReadable =
      new LinkedHashMap<>();
  private Map<Region, Set<Region>> regionsToInnerRegions =
      new LinkedHashMap<>();
  private Map<Region, Long> regionsToProcessedPerformance =
      new LinkedHashMap<>();
  private Map<Region, Double> regionsToProcessedPerformanceHumanReadable =
      new LinkedHashMap<>();
  ...
  public DefaultPerformanceEntry(Execution execution) {
    ...
    //
    //        this.regionsToRawPerformanceHumanReadable =
    //        DefaultPerformanceEntry.toHumanReadable(this.regionsToRawPerformance);
    this.regionsToProcessedPerformanceHumanReadable =
        DefaultPerformanceEntry.toHumanReadable(
            this.regionsToProcessedPerformance);
  }
  ...
  //        DefaultPerformanceEntry.toHumanReadable(this.regionsToRawPerformance);
  //        this.regionsToProcessedPerformanceHumanReadable =
  //        DefaultPerformanceEntry.toHumanReadable(this.regionsToProcessedPerformance);
  //    }
  ...
  private void calculateProcessedPerformance(List<Region> trace) {
    ...
    for (Region region : trace) {
      if (executingRegions.isEmpty() ||
          !executingRegions.peek().getRegionID().equals(region.getRegionID())) {
    ...
    if (!executingRegions.isEmpty()) {
      throw new RuntimeException(
          "There were executing regions left that were not processed");
    }
  }
  ...
  public void calculateInnerRegions(List<Region> trace) {
    ...
    if (!this.regionsToRawPerformance.keySet().equals(
            this.regionsToInnerRegions.keySet())) {
      throw new RuntimeException(
          "The regions obtained in the raw performance do not match the region obtained"
    ...
    for (Region region : trace) {
      ...
      if (top.getRegionID().equals(region.getRegionID())) {
        ...
        for (Region executingRegion : executingRegions) {
          Set<Region> innerRegions =
              this.regionsToInnerRegions.get(executingRegion);
  ...
  public Set<String> getConfiguration() { return configuration; }
  ...
  public void
  setRegionsToRawPerformance(Map<Region, Long> regionsToRawPerformance) {
  ...
  public void setRegionsToRawPerformanceHumanReadable(
      Map<Region, Double> regionsToRawPerformanceHumanReadable) {
    this.regionsToRawPerformanceHumanReadable =
        regionsToRawPerformanceHumanReadable;
  }
  ...
  public void
  setRegionsToInnerRegions(Map<Region, Set<Region>> regionsToInnerRegions) {
  ...
  public void setRegionsToProcessedPerformance(
      Map<Region, Long> regionsToProcessedPerformance) {
  ...
  public void setRegionsToProcessedPerformanceHumanReadable(
      Map<Region, Double> regionsToProcessedPerformanceHumanReadable) {
    this.regionsToProcessedPerformanceHumanReadable =
        regionsToProcessedPerformanceHumanReadable;
  }

  @Override
  public void writeToFile(PerformanceEntry performanceEntry)
      throws IOException {
    // TODO
    throw new RuntimeException();
  }
