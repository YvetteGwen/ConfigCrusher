...
public class ColorCounterAdapter extends BaseAdapter {
  ...
  public ColorCounterAdapter() { this(null, null, null); }

  public ColorCounterAdapter(String programName, String entryPoint,
                             String dir) {
    super(programName, entryPoint, dir,
          ColorCounterAdapter.getColorCounterOptions());
  }

  public static List<String> getColorCounterOptions() {
    String[] options = {"FREQTHRESHOLD", "DISTTHRESHOLD", "MINALPHA", "TIMEOUT",
                        "LOGLEVEL"};
