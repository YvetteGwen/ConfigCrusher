...
public class Execution {
  ...
  private Map<String, Long> regionsToProcessedPerformance =
      new LinkedHashMap<>();

  private Execution() { ; }

  public Execution(Set<String> configuration,
  ...
  //                        throw new RuntimeException("The end time of a future
  //                        region is less than the start time of previously
  //                        visited region");
  //                    }
  //
  ...
  //
  //        if(!executingRegions.empty()) {
  //            throw new RuntimeException("The execution trace had an executing
  //            region that was not ended");
  //        }
  //
  //    }
