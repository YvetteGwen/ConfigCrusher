...
public class PngtasticAdapter extends BaseAdapter {
  ...
  public PngtasticAdapter(String programName, String mainClass,
                          String directory) {
    //        super(programName, mainClass, directory);
    super(null, null, null, null);
  }

  public static String[] adaptConfigurationToProgram(
      Set<String> configuration) {
    String[] sleepConfiguration =
        new String[PngtasticAdapter.CONFIGURATIONS.length];
  ...
  adaptConfigurationToPerformanceMeasurement(String[] configuration) {
  ...
  public void execute(Set<String> configuration) {
    String[] argsArray =
        PngtasticAdapter.adaptConfigurationToProgram(configuration);
    ...
    //        BaseAdapter.executeJavaProgram(programName,
    //        PngtasticMain.PNGTASTIC_MAIN, this.mainClass, this.directory,
    //        args.toString().trim());
  }
}
