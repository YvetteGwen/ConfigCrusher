...
public class Output {
  ...
  //
  //        String root = USER_HOME +
  //        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/original/dummy/src/";
  ////        String root = USER_HOME +
  ///"/Documents/Programming/Java/Projects/performance-mapper-evaluation/original/jarchivelib/src/main/java/";
  ////        String root = USER_HOME +
  ///"/Documents/Programming/Java/Projects/performance-mapper-evaluation/original/java-lame/src/main/java/";
  ////        String root = USER_HOME +
  ///"/Documents/Programming/Java/Projects/performance-mapper-evaluation/original/pngtastic/src/main/java/";
  ////        String root = USER_HOME +
  ///"/Documents/Programming/Java/Projects/performance-mapper-evaluation/original/elevator/src/";
  ////        String root = USER_HOME +
  ...
  //        extensions, true); List<String> dbEntries = getDBEntries("loadtime",
  //        "Tests");
  //
  //        for(File file : files) {
  ...
  //                    file.getPath().replace(root, "")); DataInputStream in =
  //                    new DataInputStream(fstream); BufferedReader br = new
  //                    BufferedReader(new InputStreamReader(in)); String
  //                    strLine = br.readLine(); in.close();
  //
  //                    if(!strLine.contains((String)
  //                    entry.get(Output.PACKAGE))) {
  //                        continue;
  //                    }
  //                } catch (Exception e) {
  ...
  //                }
  //
  //                int javaLineNumber = (int) (long)
  //                entry.get(Output.JAVA_LINE_NO); List<String> usedTerms =
  //                (List<String>) entry.get(Output.USED_TERMS);
  ...
  //            try {
  //                FileInputStream fstream = new FileInputStream(root +
  //                file.getPath().replace(root, "")); DataInputStream in = new
  ...
  //                        lotrackedFile.append("// LT CONSTRAINT
  //                        ").append(linesToConstraints.get(lineNumber));
  //                    }
  //
  ...
  //                PrintWriter(file.getAbsolutePath().replace(".java", "") +
  //                "LOTRACK.java")) {
  ...
  //    }
  //
  //    public static List<String> getDBEntries(String database, String program)
