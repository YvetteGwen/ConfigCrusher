...
public class TimerInstrumenterTest {
  ...
  //    @Test
  //    public void testSleep30() throws NoSuchMethodException, IOException,
  //    IllegalAccessException, InvocationTargetException {
  //        String programName = "sleep30";
  //        String instrumentedSrcDirectory = BaseAdapter.USER_HOME +
  //        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/dummy/";
  //        String instrumentedClassDirectory = BaseAdapter.USER_HOME +
  ...
  //        Formatter.format(instrumentedSrcDirectory,
  //        instrumentedClassDirectory, instrumentSrcDirectory,
  //        instrumentClassDirectory);
  //
  //        // Program arguments
  //    String[] args = new String[0];

  protected void compile() throws IOException, InterruptedException {
    Instrumenter compiler = new CompileInstrumenter(
        TimerInstrumenterTest.srcDir, TimerInstrumenterTest.classDir);
    compiler.compileFromSource();
  }

  //    @Test
  //    public void testElevatorSimple() throws NoSuchMethodException,
  ...
  //        ConfigCrusherTimerRegionInstrumenter(srcDirectory, classDirectory,
  //        decisionsToOptions); instrumenter.instrument(args);
  //    }

  //    @Test
  //    public void testElevator() throws NoSuchMethodException, IOException,
  //    IllegalAccessException, InvocationTargetException {
  ...
  //        analysis.analyze(args);
  //
  //        Instrumenter.instrument(instrumentSrcDirectory,
  //        instrumentClassDirectory, decisionsToOptions);
  //    }

  protected void format() throws InvocationTargetException,
    ...
    Instrumenter compiler = new Formatter(TimerInstrumenterTest.srcDir,
                                          TimerInstrumenterTest.classDir);
  ...
  //    @Test
  //    public void testSleep31() throws NoSuchMethodException, IOException,
  //    IllegalAccessException, InvocationTargetException {
  ...
  //    @Test
  //    public void testGPL() throws NoSuchMethodException, IOException,
  //    IllegalAccessException, InvocationTargetException {
  //        String programName = "gpl";
  //        String classDirectory = BaseAdapter.USER_HOME +
  //        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/gpl/out/production/gpl/";
  //        String srcDirectory = BaseAdapter.USER_HOME +
  //        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/gpl/";
  //
  //        // Program arguments
  //        String[] args = new String[0];
  //
  ...
  //
  //    @Test
  //    public void testSleep1() throws NoSuchMethodException, IOException,
  //    IllegalAccessException, InvocationTargetException {
  ...
  //
  //    @Test
  //    public void testSleep3() throws NoSuchMethodException, IOException,
  //    IllegalAccessException, InvocationTargetException {
  ...
  //
  //    @Test
  //    public void testSleep17() throws NoSuchMethodException, IOException,
  //    IllegalAccessException, InvocationTargetException {
  ...
  public void runningExample()
    ...
    TimerInstrumenterTest.srcDir =
        BaseAdapter.USER_HOME +
        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/running-example";
    TimerInstrumenterTest.classDir =
        BaseAdapter.USER_HOME +
    ...
    Instrumenter instrumenter = new ConfigCrusherTimerRegionInstrumenter(
        programName, entry, TimerInstrumenterTest.classDir, decisionsToOptions);
  ...
  public void colorCounter()
    ...
    TimerInstrumenterTest.srcDir =
        BaseAdapter.USER_HOME +
        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/pngtastic-counter";
    TimerInstrumenterTest.classDir =
        BaseAdapter.USER_HOME +
  ...
  public void optimizer()
    ...
    TimerInstrumenterTest.srcDir =
        BaseAdapter.USER_HOME +
        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/pngtastic-optimizer";
    TimerInstrumenterTest.classDir =
        BaseAdapter.USER_HOME +
  ...
  public void jrip()
    ...
    TimerInstrumenterTest.srcDir =
        BaseAdapter.USER_HOME +
        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/jrip";
    TimerInstrumenterTest.classDir =
        BaseAdapter.USER_HOME +
        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/jrip/target/classes";
  ...
  public void prevayler()
    ...
    TimerInstrumenterTest.srcDir =
        BaseAdapter.USER_HOME +
        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/prevayler";
    TimerInstrumenterTest.classDir =
        BaseAdapter.USER_HOME +
  ...
  public void kanzi()
    ...
    TimerInstrumenterTest.srcDir =
        BaseAdapter.USER_HOME +
        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/kanzi";
    TimerInstrumenterTest.classDir =
        BaseAdapter.USER_HOME +
  ...
  public void grep()
    ...
    TimerInstrumenterTest.srcDir =
        BaseAdapter.USER_HOME +
        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/grep";
    TimerInstrumenterTest.classDir =
        BaseAdapter.USER_HOME +
  ...
  public void density()
    ...
    TimerInstrumenterTest.srcDir =
        BaseAdapter.USER_HOME +
        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/density";
    TimerInstrumenterTest.classDir =
        BaseAdapter.USER_HOME +
  ...
  public void email()
    ...
    TimerInstrumenterTest.srcDir =
        BaseAdapter.USER_HOME +
        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/email";
    TimerInstrumenterTest.classDir =
        BaseAdapter.USER_HOME +
  ...
  public void sort()
    ...
    TimerInstrumenterTest.srcDir =
        BaseAdapter.USER_HOME +
        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/sort";
    TimerInstrumenterTest.classDir =
        BaseAdapter.USER_HOME +
        "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/sort/target/classes";
