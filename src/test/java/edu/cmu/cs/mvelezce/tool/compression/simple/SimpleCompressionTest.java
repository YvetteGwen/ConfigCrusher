...
public class SimpleCompressionTest {
  ...
  public static void checktOptionsPermuatationsToGetConfigurationsToExecute(
    ...
    Collection<List<Set<String>>> permutations =
        CollectionUtils.permutations(relevantOptionsSet);
    ...
    for (List<Set<String>> permutation : permutations) {
      ...
      SimpleCompressionTest.checkConfigurationIsStatisfied(
          new HashSet<>(permutation), results);
    }
  }

  public static void
  checkConfigurationIsStatisfied(Set<Set<String>> relevantOptionsSet,
    ...
    for (Set<String> relevantOptions : relevantOptionsSet) {
      ...
      for (Set<String> configuration : powerSet) {
        //                    System.out.println("Want configuration: " +
        //                    configuration + " from: " +
        //                    relevantOptionsConvenient);
        boolean hasConfiguration = false;

        for (Set<String> result : results) {
          if (SimpleCompressionTest.matches(result, configuration,
                                            relevantOptions)) {
  ...
  public void testGetConfigurationsToExecutePipeline1() throws IOException {
    ...
    // Options
    Set<Set<String>> relevantOptionsSet =
        BaseCompressionTest.getOptionsSet("AB, AC, AD, BE");

    // Program
    String programName = "test1";

    Compression compressor =
        new SimpleCompression(programName, relevantOptionsSet);
  ...
  public void testGetConfigurationsToExecutePipeline2() throws IOException {
    ...
    // Options
    Set<Set<String>> relevantOptionsSet =
        BaseCompressionTest.getOptionsSet("ABC, BCD");
  ...
  public void testGetConfigurationsToExecutePipeline3() throws IOException {
    ...
    // Options
    Set<Set<String>> relevantOptionsSet =
        BaseCompressionTest.getOptionsSet("AB, BCD");
  ...
  public void testGetConfigurationsToExecutePipeline4() throws IOException {
    ...
    // Options
    Set<Set<String>> relevantOptionsSet =
        BaseCompressionTest.getOptionsSet("AB, BC");
  ...
  public void testGetConfigurationsToExecutePipeline5() throws IOException {
    ...
    // Options
    Set<Set<String>> relevantOptionsSet =
        BaseCompressionTest.getOptionsSet("AB, CDE");
  ...
  public void testGetConfigurationsToExecutePipeline6() throws IOException {
    ...
    // Options
    Set<Set<String>> relevantOptionsSet =
        BaseCompressionTest.getOptionsSet("AB, AC, BC");
  ...
  public void testGetConfigurationsToExecutePipeline7() throws IOException {
    ...
    // Options
    Set<Set<String>> relevantOptionsSet =
        BaseCompressionTest.getOptionsSet("AB, AC, AD, BC, BD");
  ...
  public void testGetConfigurationsToExecutePipeline8() throws IOException {
    ...
    // Options
    Set<Set<String>> relevantOptionsSet =
        BaseCompressionTest.getOptionsSet("AB, AC, AD, BC, CD");
  ...
  public void testGetConfigurationsToExecutePipeline9() throws IOException {
    ...
    // Options
    Set<Set<String>> relevantOptionsSet =
        BaseCompressionTest.getOptionsSet("ABC, CD, BD");
  ...
  public void testGetConfigurationsToExecutePipeline10() throws IOException {
    ...
    // Options
    Set<Set<String>> relevantOptionsSet =
        BaseCompressionTest.getOptionsSet("ABC, CD");
  ...
  public void testGetConfigurationsToExecutePipeline11() throws IOException {
    ...
    // Options
    Set<Set<String>> relevantOptionsSet =
        BaseCompressionTest.getOptionsSet("ABC, DEF");
  ...
  public void testGetConfigurationsToExecutePipeline13() throws IOException {
    ...
    // Options
    Set<Set<String>> relevantOptionsSet =
        BaseCompressionTest.getOptionsSet("ABCD, ADXY, ABDX");
  ...
  public void testGetConfigurationsToExecutePipeline14() throws IOException {
    ...
    // Options
    Set<Set<String>> relevantOptionsSet =
        BaseCompressionTest.getOptionsSet("AB, AC, AD, BC, CD, BD");
  ...
  public void testPngtastic() throws IOException {
    ...
    //
    //        Map<JavaRegion, Set<Set<String>>> decisionsToOptionsSet =
    ...
    //        SimpleCompression.expandOptions(decisionsToOptionsSet.values());
    //
    //        Compression compressor = new SimpleCompression(programName);
    //        Set<Set<String>> configurationsToExecute =
    //        compressor.compressConfigurations(args, options);
  ...
  public void runningExample() throws IOException {
    ...
    Map<JavaRegion, Set<Set<String>>> decisionsToOptionsSet =
        taintflowAnalysis.analyze(args);
    ...
    Set<Set<String>> configurationsToExecute =
        compressor.compressConfigurations(args);
    System.out.println(configurationsToExecute.size());
  }
  ...
  public void Sleep1() throws IOException {
    ...
    ////        args[0] = "-saveres";
    //
    //        StaticAnalysis taintflowAnalysis = new
    //        TaintFlowAnalysis(programName); Map<JavaRegion, Set<Set<String>>>
    //        decisionsToOptionsSet = taintflowAnalysis.analyze(args);
    //
    //        args = new String[2];
    //        args[0] = "-delres";
    //        args[1] = "-saveres";
    ...
    //
    //        Compression compressor = new SimpleCompression(programName,
    //        options); Set<Set<String>> configurationsToExecute =
    //        compressor.compressConfigurations(args);
    //        System.out.println(configurationsToExecute.size());
  }
