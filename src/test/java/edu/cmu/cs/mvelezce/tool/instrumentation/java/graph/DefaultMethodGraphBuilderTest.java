...
public class DefaultMethodGraphBuilderTest {
  ...
  @Test
  public void kanzi() throws NoSuchMethodException, IOException,
    ...
    ClassTransformer reader = new DefaultBaseClassTransformer(path);
    ClassNode classNode =
        reader.readClass(CompressedOutputStream.class.getCanonicalName());
  ...
  //        ClassNode classNode =
  //        reader.readClass(Dummy6.class.getCanonicalName());
  //
  ...
  //                DefaultMethodGraphBuilder.build(method);
  ...
  //        ClassTransformer reader = new DefaultBaseClassTransformer();
  //        ClassNode classNode =
  //        reader.readClass(Dummy.class.getCanonicalName());
  //
  //        List<MethodNode> methods = classNode.methods;
  //
  //        for(MethodNode method : methods) {
  ...
  //        ClassTransformer reader = new DefaultBaseClassTransformer();
  //        ClassNode classNode =
  //        reader.readClass(Dummy5.class.getCanonicalName());
  //
  //        List<MethodNode> methods = classNode.methods;
  //
  //        for(MethodNode method : methods) {
  ...
  //        ClassTransformer reader = new DefaultBaseClassTransformer();
  //        ClassNode classNode =
  //        reader.readClass(Sleep20.class.getCanonicalName());
  //
  //        List<MethodNode> methods = classNode.methods;
  //
  //        for(MethodNode method : methods) {
  ...
  //        ClassTransformer reader = new DefaultBaseClassTransformer();
  //        ClassNode classNode =
  //        reader.readClass(Dummy3.class.getCanonicalName());
  //
  //        List<MethodNode> methods = classNode.methods;
  //
  //        for(MethodNode method : methods) {
