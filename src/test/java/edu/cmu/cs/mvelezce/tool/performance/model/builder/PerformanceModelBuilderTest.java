...
public class PerformanceModelBuilderTest {
  ...
  //
  //        Map<JavaRegion, Set<String>> partialRegionsToOptions = null; // TODO
  //        make change since interface changed ProgramAnalysis.analyze(program,
  //        args); Set<PerformanceEntry> measuredPerformance =
  //        BaseExecutor.measureConfigurationPerformance(program, args);
  //
  ...
  //        regionsToOptions); System.out.println(pm);
  //    }
  //
  //    @Test
  ...
  //        make change since interface changed ProgramAnalysis.analyze(program,
  //        args); Set<PerformanceEntry> measuredPerformance =
  //        BaseExecutor.repeatMeasureConfigurationPerformance(program, args);
  //
  //        Map<Region, Set<String>> regionsToOptions = new HashMap<>();
  //
  //        for(Map.Entry<JavaRegion, Set<String>> entry :
  ...
  //
  //        PerformanceModel pm =
  //        ConfigCrusherPerformanceModelBuilder.createPerformanceModel(program,
  ...
  //        SimpleCompressionTest.getOptionsSet("A"); Set<Set<String>>
  //        configurationsToExecute =
  //        Helper.getConfigurations(optionsSet.iterator().next());
  //
  //        Set<PerformanceEntry> measuredPerformance =
  //        BaseExecutor.measureConfigurationPerformance(Sleep1.CLASS, args,
  //        Sleep1.FILENAME,
  //        ConfigCrusherTimerRegionInstrumenter.TARGET_DIRECTORY + "/" +
  //        Sleep1.CLASS, configurationsToExecute);
  //
  //        // Program arguments
  //        args = new String[2];
  //        args[0] = "-delres";
  ...
  //
  //        // Execute
  //        PerformanceModel outputSave =
  //        ConfigCrusherPerformanceModelBuilder.createPerformanceModel(Sleep1.CLASS,
  //        args, measuredPerformance, regionsToOptions);
  //
  //        args = new String[0];
  //        PerformanceModel outputRead =
  //        ConfigCrusherPerformanceModelBuilder.createPerformanceModel(Sleep1.CLASS,
  //        args, measuredPerformance, regionsToOptions);
  //
  ...
  //
  //    @Test
  //    public void testCreatePerformanceModel1() throws IOException,
  //    ParseException {
  //        // Map<Region, Set<String>> regionsToOptions
  //        Map<Region, Set<String>> regionsToOptions = new HashMap<>();
  //        Set<String> relevantOptions = new HashSet<>();
  ...
  //        performanceModel.evaluate(configuration), 0.05);
  //
  ...
  //
  //    @Test
  //    public void testCreatePerformanceModel2() throws IOException,
  //    ParseException {
  //        // Map<Region, Set<String>> regionsToOptions
  //        Map<Region, Set<String>> regionsToOptions = new HashMap<>();
  //        Set<String> relevantOptions = new HashSet<>();
  ...
  //
  //        Set<PerformanceEntry> measuredPerformance =
  //        BaseExecutor.measureConfigurationPerformance(Sleep2.CLASS, args,
  //        Sleep2.FILENAME,
  //        ConfigCrusherTimerRegionInstrumenter.TARGET_DIRECTORY + "/" +
  //        Sleep2.CLASS, configurationsToExecute);
  //
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        ConfigCrusherPerformanceModelBuilder.createPerformanceModel(measuredPerformance,
  ...
  //
  //    @Test
  //    public void testCreatePerformanceModel3() throws IOException,
  //    ParseException {
  //        // Map<Region, Set<String>> regionsToOptions
  //        Map<Region, Set<String>> regionsToOptions = new HashMap<>();
  //        Set<String> relevantOptions = new HashSet<>();
  ...
  //
  //        Set<PerformanceEntry> measuredPerformance =
  //        BaseExecutor.measureConfigurationPerformance(Sleep3.CLASS, args,
  //        Sleep3.FILENAME,
  //        ConfigCrusherTimerRegionInstrumenter.TARGET_DIRECTORY + "/" +
  //        Sleep3.CLASS, configurationsToExecute);
  //
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        ConfigCrusherPerformanceModelBuilder.createPerformanceModel(measuredPerformance,
  ...
  //
  //    @Test
  //    public void testCreatePerformanceModel4() throws IOException,
  //    ParseException {
  //        // Map<Region, Set<String>> regionsToOptions
  //        Map<Region, Set<String>> regionsToOptions = new HashMap<>();
  //        Set<String> relevantOptions = new HashSet<>();
  ...
  //
  //        Set<PerformanceEntry> measuredPerformance =
  //        BaseExecutor.measureConfigurationPerformance(Sleep4.CLASS, args,
  //        Sleep4.FILENAME,
  //        ConfigCrusherTimerRegionInstrumenter.TARGET_DIRECTORY + "/" +
  //        Sleep4.CLASS, configurationsToExecute);
  //
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        ConfigCrusherPerformanceModelBuilder.createPerformanceModel(measuredPerformance,
  ...
  //
  //    @Test
  //    public void testCreatePerformanceModel7() throws IOException,
  //    ParseException {
  //        // Map<Region, Set<String>> regionsToOptions
  //        Map<Region, Set<String>> regionsToOptions = new HashMap<>();
  //        Set<String> relevantOptions = new HashSet<>();
  ...
  //
  //        Set<PerformanceEntry> measuredPerformance =
  //        BaseExecutor.measureConfigurationPerformance(Sleep7.CLASS, args,
  //        Sleep7.FILENAME,
  //        ConfigCrusherTimerRegionInstrumenter.TARGET_DIRECTORY + "/" +
  //        Sleep7.CLASS, configurationsToExecute);
  //
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        ConfigCrusherPerformanceModelBuilder.createPerformanceModel(measuredPerformance,
  ...
  //
  //    @Test
  //    public void testCreatePerformanceModel8() throws IOException,
  //    ParseException {
  //        // Map<Region, Set<String>> regionsToOptions
  //        Map<Region, Set<String>> regionsToOptions = new HashMap<>();
  //        Set<String> relevantOptions = new HashSet<>();
  ...
  //
  //        Set<PerformanceEntry> measuredPerformance =
  //        BaseExecutor.measureConfigurationPerformance(Sleep8.CLASS, args,
  //        Sleep8.FILENAME,
  //        ConfigCrusherTimerRegionInstrumenter.TARGET_DIRECTORY + "/" +
  //        Sleep8.CLASS, configurationsToExecute);
  //
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        ConfigCrusherPerformanceModelBuilder.createPerformanceModel(measuredPerformance,
  ...
  //
  //    @Test
  //    public void testCreatePerformanceModel9() throws IOException,
  //    ParseException {
  //        // Map<Region, Set<String>> regionsToOptions
  //        Map<Region, Set<String>> regionsToOptions = new HashMap<>();
  //        Set<String> relevantOptions = new HashSet<>();
  ...
  //
  //        Set<PerformanceEntry> measuredPerformance =
  //        BaseExecutor.measureConfigurationPerformance(Sleep9.CLASS, args,
  //        Sleep9.FILENAME,
  //        ConfigCrusherTimerRegionInstrumenter.TARGET_DIRECTORY + "/" +
  //        Sleep9.CLASS, configurationsToExecute);
  //
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        ConfigCrusherPerformanceModelBuilder.createPerformanceModel(measuredPerformance,
  ...
  //
  //    @Test
  //    public void testCreatePerformanceModel10() throws IOException,
  //    ParseException {
  //        // Map<Region, Set<String>> regionsToOptions
  //        Map<Region, Set<String>> regionsToOptions = new HashMap<>();
  //        Set<String> relevantOptions = new HashSet<>();
  ...
  //
  //        Set<PerformanceEntry> measuredPerformance =
  //        BaseExecutor.measureConfigurationPerformance(Sleep10.CLASS, args,
  //        Sleep10.FILENAME,
  //        ConfigCrusherTimerRegionInstrumenter.TARGET_DIRECTORY + "/" +
  //        Sleep10.CLASS, configurationsToExecute);
  //
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        ConfigCrusherPerformanceModelBuilder.createPerformanceModel(measuredPerformance,
  ...
  //
  //    @Test
  //    public void testCreatePerformanceModel13() throws IOException,
  //    ParseException {
  //        // Map<Region, Set<String>> regionsToOptions
  //        Map<Region, Set<String>> regionsToOptions = new HashMap<>();
  //        Set<String> relevantOptions = new HashSet<>();
  ...
  //
  //        Set<PerformanceEntry> measuredPerformance =
  //        BaseExecutor.measureConfigurationPerformance(Sleep13.CLASS, args,
  //        Sleep13.FILENAME,
  //        ConfigCrusherTimerRegionInstrumenter.TARGET_DIRECTORY + "/" +
  //        Sleep13.CLASS, configurationsToExecute);
  //
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        ConfigCrusherPerformanceModelBuilder.createPerformanceModel(measuredPerformance,
