...
public class FormatterTest {
  ...
  //        instrumentedSrcDirectory, instrumentedClassDirectory);
  //    }
  //
  //    @Test
  //    public void instrumentElevator() throws IOException,
