...
public class BaseExecutorTest {
  ...
  //
  //                    for(Map.Entry<Region, Long> actualResultEntry :
  //                    actual.getRegionsToExecutionTime().entrySet()) {
  //                        for(Map.Entry<Region, Long> expectedResultEntry :
  //                        expected.getRegionsToExecutionTime().entrySet()) {
  ...
  //
  //    @Test
  //    public void testMeasureConfigurationPerformancePipeline1() throws
  //    Exception {
  //        // Program arguments
  ...
  //
  //    @Test
  //    public void testMeasureConfigurationPerformancePipeline2() throws
  //    Exception {
  //        // Program arguments
  //        String[] args = new String[2];
  //        args[0] = "-delres";
  ...
  //
  //    @Test
  //    public void testMeasureConfigurationPerformancePipeline3() throws
  //    Exception {
  //        // Program arguments
  //        String[] args = new String[2];
  //        args[0] = "-delres";
  ...
  //
  //    @Test
  //    public void testMeasureConfigurationPerformancePipeline4() throws
  //    Exception {
  //        // Program arguments
  //        String[] args = new String[2];
  //        args[0] = "-delres";
  ...
  //
  //    @Test
  //    public void testMeasureConfigurationPerformancePipeline7() throws
  //    Exception {
  //        // Program arguments
  //        String[] args = new String[2];
  //        args[0] = "-delres";
  ...
  //
  //    @Test
  //    public void testMeasureConfigurationPerformancePipeline8() throws
  //    Exception {
  //        // Program arguments
  //        String[] args = new String[2];
  //        args[0] = "-delres";
  ...
  //
  //    @Test
  //    public void testMeasureConfigurationPerformancePipeline9() throws
  //    Exception {
  //        // Program arguments
  //        String[] args = new String[2];
  //        args[0] = "-delres";
  ...
  //
  //    @Test
  //    public void testMeasureConfigurationPerformancePipeline10() throws
  //    Exception {
  //        // Program arguments
  //        String[] args = new String[2];
  //        args[0] = "-delres";
  ...
  //
  //    @Test
  //    public void testMeasureConfigurationPerformancePipeline13() throws
  //    Exception {
  //        // Program arguments
  //        String[] args = new String[2];
  //        args[0] = "-delres";
  ...
  ////        String classDirectory = USER_HOME +
  ...
  /// entryPoint, classDirectory, configurations); /    }
  //
  //    @Test
  ...
  //        Compression compression = new SimpleCompression(programName);
  //        Set<Set<String>> configurations =
  //        compression.compressConfigurations(args); Set<String> options = new
  //        HashSet<>();
  //
  ...
  //
  //        Set<PerformanceEntry> measuredPerformance =
  //        BaseExecutor.repeatMeasureConfigurationPerformance(programName,
  //        args);
  //    }
}