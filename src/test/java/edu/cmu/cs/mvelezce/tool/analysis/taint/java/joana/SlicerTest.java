...
public class SlicerTest {
  ...
  ////        BuildSDG.standardConcBuild(USER_HOME +
  ///"/Documents/Programming/Java/Projects/performance-mapper-evaluation/original/dummy/out/production/dummy",
  ////                className + "." + name,
  ////                USER_HOME +
  ///"/Documents/Programming/Java/Projects/performancemodel-mapper/src/main/resources/joana/programs/sleep19/"
  ///+ name + ".pdg");
  //    }
  //
  //    @Test
  //    public void testSleep19() throws IOException {
  //        String file = USER_HOME +
  //        "/Documents/Programming/Java/Projects/performancemodel-mapper/src/main/resources/joana/programs/sleep19/edu.cmu.cs.mvelezce.Sleep19.main.pdg";
  //        String entryPoint = "edu.cmu.cs.mvelezce.Sleep19.main";
  //        String criterionFormat = "booleanValue()";
  //        List<String> features = new ArrayList<>();
  //        features.add("A");
  //
  //        List<String> criterionLabels = Slicer.getCriterionLabel(file,
  //        entryPoint, criterionFormat); Assert.assertEquals(features.size(),
  //        criterionLabels.size());
  //
  ...
  //        Slicer.analyze(file, featuresToLabels); Assert.assertEquals(1,
  //        partialRegionsToOptions.size());
  //    }
  //
  //    @Test
  ...
  //
  //        Map<JavaRegion, Set<String>> partialRegionsToOptions =
  //        Slicer.analyze(file, featuresToLabels); Assert.assertEquals(2,
  //        partialRegionsToOptions.size());
  //    }
  //
  //    @Test
  ...
  //
  //        Map<JavaRegion, Set<String>> partialRegionsToOptions =
  //        Slicer.analyze(file, featuresToLabels); Assert.assertEquals(3,
  //        partialRegionsToOptions.size());
  //    }
  //
  //    @Test
  ...
  //
  //        Map<JavaRegion, Set<String>> partialRegionsToOptions =
  //        Slicer.analyze(file, featuresToLabels); Assert.assertEquals(6,
  //        partialRegionsToOptions.size());
  //    }
  //
  //    @Test
  ...
  //
  //        Map<JavaRegion, Set<String>> partialRegionsToOptions =
  //        Slicer.analyze(file, featuresToLabels); Assert.assertEquals(8,
  //        partialRegionsToOptions.size());
  //    }
  //
  //    @Test
  ...
  //
  //        Map<JavaRegion, Set<String>> partialRegionsToOptions =
  //        Slicer.analyze(file, featuresToLabels); Assert.assertEquals(7,
  //        partialRegionsToOptions.size());
  //    }
  //
  //    @Test
