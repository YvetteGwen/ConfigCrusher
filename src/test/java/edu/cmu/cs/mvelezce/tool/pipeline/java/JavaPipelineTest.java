...
public class JavaPipelineTest {
  ...
  public void testSleep14()
    ...
    PerformanceModel pm = JavaPipeline.buildPerformanceModel(
        programName, args, srcDirectory, classDirectory, entryPoint);
    ...
    for (Set<String> configuration : configurations) {
      ...
      //            System.out.println(Region.getSecondsExecutionTime(start,
      //            end)); Assert.assertEquals(pm.evaluate(configuration),
      //            Region.getSecondsExecutionTime(start, end),
      //            JavaPipelineTest.TIMING_ERROR);
    }
  }
  ...
  public void testZip()
    ...
    Map<JavaRegion, Set<String>> partialRegionsToOptions =
        null; // TODO make change since interface changed
              // ProgramAnalysis.analyze(programName, args);
    ...
    //        originalSrcDirectory, originalClassDirectory,
    //                instrumentSrcDirectory, instrumentClassDirectory,
    //                entryPoint, partialRegionsToOptions);
    JavaPipeline.buildPerformanceModelRepeat(
        programName, args, originalSrcDirectory, originalClassDirectory,
        instrumentSrcDirectory, instrumentClassDirectory, entryPoint,
        partialRegionsToOptions);
  }
  ...
  public void testPngtastic()
    ...
    //        JavaPipeline.buildPerformanceModelRepeat(programName, args,
    //        originalSrcDirectory, originalClassDirectory,
    //                instrumentSrcDirectory, instrumentClassDirectory,
    //                entryPoint);
    JavaPipeline.buildPerformanceModelRepeat(
  ...
  public void testSleep1_1()
    ...
    PerformanceModel pm = JavaPipeline.buildPerformanceModel(
        programName, args, srcDirectory, classDirectory, entryPoint, sdgFile,
        features);
    System.out.println(pm);
  }
  ...
  public void testSleep10()
      throws IOException, InterruptedException, NoSuchMethodException,
             IllegalAccessException, InvocationTargetException {
    // TODO method 1 and method 2 depend on features so instrumentation is not
    // needed
    String programName = "sleep10";
    String srcDirectory =
        BaseAdapter.USER_HOME +
  ...
  //        // Java Region
  //        // Indexes were gotten by looking at output of running
  //        ClassTransformerBaseTest Set<JavaRegion> regions = new HashSet<>();
  //        JavaRegion region = new JavaRegion(Sleep3.PACKAGE, Sleep3.CLASS,
  //        Sleep3.MAIN_METHOD, 31, 36); Regions.addRegion(region);
  //
  //        region = new JavaRegion(Sleep3.PACKAGE, Sleep3.CLASS,
  //        Sleep3.MAIN_METHOD, 48, 53); Regions.addRegion(region);
  //
  //        region = new JavaRegion(Sleep3.PACKAGE, Sleep3.CLASS,
  //        Sleep3.METHOD_1, 19, 20); Regions.addRegion(region);
  //
  //        region = new JavaRegion(Sleep3.PACKAGE, Sleep3.CLASS,
  //        Sleep3.METHOD_2, 19, 20); Regions.addRegion(region);
  //
  //        // Program files
  ...
  //
  //        String program =
  //        Sleep3.FILENAME.substring(Sleep3.FILENAME.lastIndexOf(".") + 1);
  //
  //        // Instrument and assert
  //        Instrumenter.instrument(program, Sleep3.FILENAME, programFiles,
  //        regions);
  //    }
  //
  //    public static void compareRegionOptionsCompressionToBF(String program,
  //    boolean csv) throws NoSuchFieldException {
  //        // program, regions, options, BF configurations, constraints,
  //        compressed configurations, compressed over BF if(csv) {
  ...
  //        }
  //
  //        Map<JavaRegion, Set<String>> queryResult =
  //        LotrackProcessor.getRegionsToOptions(JavaPipeline.LOTRACK_DATABASE,
  //        program); if(csv) {
  //            System.out.print(queryResult.size() + ", ");
  //        }
  //        else {
  //            System.out.println("Lotrack total number of regions: " +
  //            queryResult.size());
  //        }
  ...
  //    }
  //
  //    public static void compareOptionsCompressionToBF(String program, boolean
  //    csv) throws NoSuchFieldException {
  //        // program, entries, options, BF configurations, constraints,
  //        compressed configurations, compressed over BF if(csv) {
  //            System.out.print(program + ", ");
  //        }
  //        else {
  ...
  //        ScalaMongoDriverConnector.findProjection(program, fields);
  ...
  //        }
  //        else {
  //            System.out.println("Lotrack total number of entries: " +
  //            queryResult.size());
  //        }
  //
  ...
  ////                for(Object string :
  /// JSONResult.getJSONArray(LotrackProcessor.USED_TERMS).toList()) { / String
  /// possibleString = string.toString();
  ////
  ////                    if(possibleString.equals("true") ||
  /// possibleString.equals("false")) { /                        continue; / }
  ////
  ////                    options.add(string.toString());
  ////                }
  ////            }
  ////            else if(JSONResult.has(LotrackProcessor.CONSTRAINT)) {
  ////                // Be careful that this is imprecise since the constraints
  /// can be very large and does not fit in the db field / String[] constraints
  /// = JSONResult.getString(LotrackProcessor.CONSTRAINT).split(" ");
  ////
  ////                for(String constraint : constraints) {
  ////                    constraint = constraint.replaceAll("[()^|!=]", "");
  ////                    if(constraint.isEmpty() ||
  /// StringUtils.isNumeric(constraint)) { /                        continue; /
  /// }
  ////
  ////
  /// if(constraint.contains(LotrackProcessor.LOTRACK_UNKNOWN_CONSTRAINT_SYMBOL))
  ///{ /                        constraint =
  /// constraint.split(LotrackProcessor.LOTRACK_UNKNOWN_CONSTRAINT_SYMBOL)[0]; /
  ///}
  ////
  ////                    // Because the constraint gotten from Lotrack might be
  /// too long /                    if(constraint.contains(".")) { / continue; /
  ///}
  ////
  ////                    if(constraint.equals("false") ||
  /// constraint.equals("true")) { /                        continue; / }
  ////
  ////                    options.add(constraint);
  ////                }
  ////            }
  ////            else {
  ////                throw new NoSuchFieldException("The query result does not
  /// have neither a " + LotrackProcessor.USED_TERMS + " or " +
  /// LotrackProcessor.CONSTRAINT + " fields"); /            }
  ////
  ////            if(!options.isEmpty()) {
  ...
  //    }
  //
  //    public static void compare(Set<Set<String>> optionsSet, Set<String>
  //    uniqueOptions, boolean csv) {
  //        if(csv) {
  ...
  //            uniqueOptions.size()); System.out.println("Brute force number of
  //            configurations: " + (int) Math.pow(2, uniqueOptions.size()));
  //            System.out.println("Number of constraints: " +
  //            optionsSet.size());
  //        }
  //
  //        Set<Set<String>> configurations =
  //        compression.compressConfigurations(optionsSet);
  //        SimpleCompressionTest.checkConfigurationIsStatisfied(optionsSet,
  //        configurations);
  //
  //        if(csv) {
  //            System.out.print(configurations.size() + ", ");
  //            System.out.println(configurations.size()/Math.pow(2,
  //            uniqueOptions.size()));
  //        }
  //        else {
  //            System.out.println("Compressed number of configurations: " +
  //            configurations.size()); System.out.println("Compressed over BF:
  //            " + configurations.size()/Math.pow(2, uniqueOptions.size()));
  //        }
  //    }
  //
  //    @Test
  //    public void testCompareRegionOptionsCompressionToBF1() throws
  //    NoSuchFieldException {
  //        JavaPipelineTest.compareRegionOptionsCompressionToBF("platypus",
  //        false);
  //    }
  //
  //    @Test
  ...
  /// ScalaMongoDriverConnector.getCollectionNames();
  ////
  ...
  ////                System.out.println("This program does not have taint
  /// tracking info"); /            } /            System.out.println(); / }
  //    }
  //
  //    @Test
  ...
  //
  //    @Test
  //    public void testCompareOptionsCompressionToBF1() throws
  //    NoSuchFieldException {
  ...
  ////        for(String collection : collections) {
  ////            try {
  ////                JavaPipelineTest.compareOptionsCompressionToBF(collection,
  /// false); /            } /            catch(NoSuchFieldException nsfe) { /
  ...
  ////            try {
  ////                JavaPipelineTest.compareOptionsCompressionToBF(collection,
  /// true); /            } /            catch(NoSuchFieldException nsfe) { /
  /// System.out.println("This program does not have taint tracking info"); / }
  ////        }
  //    }
  //
  //    @Test
  //    public void testBuildPerformanceModel4() throws ClassNotFoundException,
  //    IOException, NoSuchMethodException, NoSuchFieldException, ParseException
  //    {
  //        // TODO we still need to get Lotrack working
  //        // Java Region
  //        // Indexes were gotten by looking at output of running
  //        ClassTransformerBaseTest JavaRegion region1 = new
  //        JavaRegion(Sleep3.PACKAGE, Sleep3.CLASS, Sleep3.MAIN_METHOD, 31,
  //        36); Regions.addRegion(region1);
  //
  //        JavaRegion region2 = new JavaRegion(Sleep3.PACKAGE, Sleep3.CLASS,
  //        Sleep3.MAIN_METHOD, 48, 53); Regions.addRegion(region2);
  //
  //        JavaRegion region3 = new JavaRegion(Sleep3.PACKAGE, Sleep3.CLASS,
  //        Sleep3.METHOD_1, 19, 20); Regions.addRegion(region3);
  //
  //        JavaRegion region4 = new JavaRegion(Sleep3.PACKAGE, Sleep3.CLASS,
  //        Sleep3.METHOD_2, 19, 20); Regions.addRegion(region4);
  //
  //        // Regions to options
  ...
  //        JavaPipeline.buildPerformanceModel(Sleep3.CLASS, Sleep3.FILENAME,
  //        programFiles, regionsToOptions);
  //
  //        // Compare
  //        double performancemodel = 0.3;
  //        Set<String> configuration = new HashSet<>();
  //        Assert.assertEquals(performancemodel,
  //        performanceModel.evaluate(configuration),
  //        JavaPipelineTest.JavaPipelineTest.TIMING_ERROR);
  //
  ...
  //
  //    @Test
  //    public void testBuildPerformanceModel1() throws ClassNotFoundException,
  //    IOException, NoSuchMethodException, NoSuchFieldException, ParseException
  //    {
  //        // TODO we still need to get Lotrack working
  //        // Java Region
  //        // Indexes were gotten by looking at output of running
  //        ClassTransformerBaseTest JavaRegion region1 = new
  //        JavaRegion(Sleep1.PACKAGE, Sleep1.CLASS, Sleep1.MAIN_METHOD, 23,
  //        24); Regions.addRegion(region1);
  //
  //        // Regions to options
  //        Map<JavaRegion, Set<String>> regionsToOptions = new HashMap<>();
  //
  ...
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        JavaPipeline.buildPerformanceModel(Sleep1.CLASS, Sleep1.FILENAME,
  //        programFiles, regionsToOptions);
  ...
  //
  //    @Test
  //    public void testBuildPerformanceModel2() throws ClassNotFoundException,
  //    IOException, NoSuchMethodException, NoSuchFieldException, ParseException
  //    {
  //        // TODO we still need to get Lotrack working
  //        // Java Region
  //        // Indexes were gotten by looking at output of running
  //        ClassTransformerBaseTest JavaRegion region1 = new
  //        JavaRegion(Sleep2.PACKAGE, Sleep2.CLASS, Sleep2.MAIN_METHOD, 23,
  //        28); Regions.addRegion(region1);
  //
  //        JavaRegion region2 = new JavaRegion(Sleep2.PACKAGE, Sleep2.CLASS,
  //        Sleep2.METHOD_1, 19, 20); Regions.addRegion(region2);
  //
  //        // Regions to options
  //        Map<JavaRegion, Set<String>> regionsToOptions = new HashMap<>();
  //
  ...
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        JavaPipeline.buildPerformanceModel(Sleep2.CLASS, Sleep2.FILENAME,
  //        programFiles, regionsToOptions);
  ////        System.out.println(performanceModel);
  //
  //        // Compare
  ...
  //
  //    @Test
  //    public void testBuildPerformanceModel6() throws ClassNotFoundException,
  //    IOException, NoSuchMethodException, NoSuchFieldException, ParseException
  //    {
  //        // TODO we still need to get Lotrack working
  //        // Java Region
  //        // Indexes were gotten by looking at output of running
  //        ClassTransformerBaseTest JavaRegion region1 = new
  //        JavaRegion(Sleep4.PACKAGE, Sleep4.CLASS, Sleep4.MAIN_METHOD, 23,
  //        24); Regions.addRegion(region1);
  //
  //        JavaRegion region2 = new JavaRegion(Sleep4.PACKAGE, Sleep4.CLASS,
  //        Sleep4.MAIN_METHOD, 29, 30); Regions.addRegion(region2);
  //
  //        // Regions to options
  //        Map<JavaRegion, Set<String>> regionsToOptions = new HashMap<>();
  //
  ...
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        JavaPipeline.buildPerformanceModel(Sleep4.CLASS, Sleep4.FILENAME,
  //        programFiles, regionsToOptions);
  //        System.out.println(performanceModel);
  //
  //        // Compare
  ...
  //
  //    @Test
  //    public void testBuildPerformanceModel7() throws ClassNotFoundException,
  //    IOException, NoSuchMethodException, NoSuchFieldException, ParseException
  //    {
  //        // TODO we still need to get Lotrack working
  //        // Java Region
  //        // Indexes were gotten by looking at output of running
  //        ClassTransformerBaseTest JavaRegion region1 = new
  //        JavaRegion(Sleep7.PACKAGE, Sleep7.CLASS, Sleep7.MAIN_METHOD, 23,
  //        24); Regions.addRegion(region1);
  //
  //        JavaRegion region2 = new JavaRegion(Sleep7.PACKAGE, Sleep7.CLASS,
  //        Sleep7.MAIN_METHOD, 29, 30); Regions.addRegion(region2);
  //
  //        // Regions to options
  //        Map<JavaRegion, Set<String>> regionsToOptions = new HashMap<>();
  //
  ...
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        JavaPipeline.buildPerformanceModel(Sleep7.CLASS, Sleep7.FILENAME,
  //        programFiles, regionsToOptions);
  //        System.out.println(performanceModel);
  //
  //        // Compare
  ...
  //
  //    @Test
  //    public void testBuildPerformanceModel8() throws ClassNotFoundException,
  //    IOException, NoSuchMethodException, NoSuchFieldException, ParseException
  //    {
  //        // TODO we still need to get Lotrack working
  //        // Java Region
  //        // Indexes were gotten by looking at output of running
  //        ClassTransformerBaseTest JavaRegion region1 = new
  //        JavaRegion(Sleep8.PACKAGE, Sleep8.CLASS, Sleep8.MAIN_METHOD, 31,
  //        36); Regions.addRegion(region1);
  //
  //        JavaRegion region2 = new JavaRegion(Sleep8.PACKAGE, Sleep8.CLASS,
  //        Sleep8.MAIN_METHOD, 41, 46); Regions.addRegion(region2);
  //
  //        // Regions to options
  //        Map<JavaRegion, Set<String>> regionsToOptions = new HashMap<>();
  //
  ...
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        JavaPipeline.buildPerformanceModel(Sleep8.CLASS, Sleep8.FILENAME,
  //        programFiles, regionsToOptions);
  //        System.out.println(performanceModel);
  //
  //        // Compare
  ...
  //
  //    @Test
  //    public void testBuildPerformanceModel9() throws ClassNotFoundException,
  //    IOException, NoSuchMethodException, NoSuchFieldException, ParseException
  //    {
  //        // TODO we still need to get Lotrack working
  //        // Java Region
  //        // Indexes were gotten by looking at output of running
  //        ClassTransformerBaseTest JavaRegion region1 = new
  //        JavaRegion(Sleep9.PACKAGE, Sleep9.CLASS, Sleep9.MAIN_METHOD, 31,
  //        36); Regions.addRegion(region1);
  //
  //        JavaRegion region2 = new JavaRegion(Sleep9.PACKAGE, Sleep9.CLASS,
  //        Sleep9.MAIN_METHOD, 41, 46); Regions.addRegion(region2);
  //
  //        // Regions to options
  //        Map<JavaRegion, Set<String>> regionsToOptions = new HashMap<>();
  //
  ...
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        JavaPipeline.buildPerformanceModel(Sleep9.CLASS, Sleep9.FILENAME,
  //        programFiles, regionsToOptions);
  ////        System.out.println(performanceModel);
  //
  //        // Compare
  ...
  //
  //    @Test
  //    public void testBuildPerformanceModel10() throws ClassNotFoundException,
  //    IOException, NoSuchMethodException, NoSuchFieldException, ParseException
  //    {
  //        // TODO we still need to get Lotrack working
  //        // Java Region
  //        // Indexes were gotten by looking at output of running
  //        ClassTransformerBaseTest JavaRegion region1 = new
  //        JavaRegion(Sleep10.PACKAGE, Sleep10.CLASS, Sleep10.MAIN_METHOD, 31,
  //        36); Regions.addRegion(region1);
  //
  //        JavaRegion region2 = new JavaRegion(Sleep10.PACKAGE, Sleep10.CLASS,
  //        Sleep10.MAIN_METHOD, 45, 50); Regions.addRegion(region2);
  //
  //        JavaRegion region3 = new JavaRegion(Sleep10.PACKAGE, Sleep10.CLASS,
  //        Sleep10.METHOD_1, 19, 20); Regions.addRegion(region3);
  //
  //        JavaRegion region4 = new JavaRegion(Sleep10.PACKAGE, Sleep10.CLASS,
  //        Sleep10.METHOD_2, 19, 20); Regions.addRegion(region4);
  //
  //        // Regions to options
  //        Map<JavaRegion, Set<String>> regionsToOptions = new HashMap<>();
  //
  ...
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        JavaPipeline.buildPerformanceModel(Sleep9.CLASS, Sleep10.FILENAME,
  //        programFiles, regionsToOptions);
  //        System.out.println(performanceModel);
  //
  //        // Compare
  ...
  //
  //    @Test
  //    public void testBuildPerformanceModel11() throws ClassNotFoundException,
  //    IOException, NoSuchMethodException, NoSuchFieldException, ParseException
  //    {
  //        // TODO we still need to get Lotrack working
  //        // Java Region
  //        // Indexes were gotten by looking at output of running
  //        ClassTransformerBaseTest JavaRegion region1 = new
  //        JavaRegion(Sleep11.PACKAGE, Sleep11.CLASS, Sleep11.MAIN_METHOD, 19,
  //        24); Regions.addRegion(region1);
  //
  //        JavaRegion region2 = new JavaRegion(Sleep11.PACKAGE, Sleep11.CLASS,
  //        Sleep11.MAIN_METHOD, 30, 35); Regions.addRegion(region2);
  //
  //        JavaRegion region3 = new JavaRegion(Sleep11.PACKAGE, Sleep11.CLASS,
  //        Sleep11.MAIN_METHOD, 39, 57); Regions.addRegion(region3);
  //
  //        // Regions to options
  //        Map<JavaRegion, Set<String>> regionsToOptions = new HashMap<>();
  //
  ...
  //        // Performance model
  //        PerformanceModel performanceModel =
  //        JavaPipeline.buildPerformanceModel(Sleep11.CLASS, Sleep11.FILENAME,
  //        programFiles, regionsToOptions);
  //        System.out.println(performanceModel);
  //
  //        // Compare
