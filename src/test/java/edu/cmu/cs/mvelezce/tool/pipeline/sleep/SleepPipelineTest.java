...
public class SleepPipelineTest {
  ...
  //    public static void checkExecutionTimes(Set<PerformanceEntry>
  //    expectedPerformances, Set<PerformanceEntry> actualPerformances) {
  ...
  /// Assert.assertEquals(actualRegion.getExecutionTime(),
  /// expectedRegion.getExecutionTime(), 0); /                        } / } / }
  //            }
  //        }
  //    }
  ...
  public void testGetConfigurationsInRelevantRegions1() {
    ...
    // Possible taint
    Set<ConstantConfigurationExpression> taintingConfigurations =
        new HashSet<>();
    ...
    TaintAnalysis.PossibleTaint possibleTaint =
        new TaintAnalysis.PossibleTaint(variable, taintingConfigurations);
    ...
    Statement statement1 =
        new IfStatement(new VariableExpression(variableValue),
    ...
    SleepRegion region =
        new SleepRegion(((IfStatement)statement1).getThenBlock());
    ...
    Statement statement2 =
        new SleepStatement(new VariableExpression(variableValue));
    ...
    //        // Assert
    //        Assert.assertEquals(relevantRegionToOptions,
  ...
  public void testMeasureConfigurationPerformance1() {
    ...
    //
    //        // TimedStatement
    //        // Sleep statement has configuration to avoid having a statement
    //        assignment Statement statement = new SleepStatement(new
    //        ConstantConfigurationExpression("B")); Region region = new
    //        SleepRegion(statement); TimedStatement timedStatement = new
    //        TimedStatement(region.getRegionID(), statement);
    ...
    //        TimedProgram timedProgram = new
    //        TimedProgram(programRegion.getRegionID(), program);
    //
    //        // Configurations
    //        Set<Set<String>> optionsSet =
    //        SimpleCompressionTest.getOptionsSet("AB"); Set<Set<String>>
    //        configurationsToExecute =
    //        Helper.getConfigurations(optionsSet.iterator().next());
    //
    ...
    //        programRegion); measuredPerformance.add(performanceEntry);
    //
    //        // Configuration A
    //        configuration = new HashSet<>();
    //        configuration.add("A");
    //        performanceEntry = new PerformanceEntry(configuration,
    //        Regions.getRegions(), programRegion);
    ...
    //
    //        // Assert
    //        Set<PerformanceEntry> results =
    //        SleepPipeline.measureConfigurationPerformance(timedProgram,
    //        configurationsToExecute); Assert.assertEquals(measuredPerformance,
    //        results);
    //        SleepPipelineTest.checkExecutionTimes(measuredPerformance,
    //        results);
  }
  ...
  public void testMeasureConfigurationPerformance2() {
    ...
    //        // Sleep statement has configuration to avoid having a statement
    //        assignment Statement statement = new SleepStatement(new
    //        ConstantIntExpression(2)); statement = new IfStatement(new
    //        ConstantConfigurationExpression("A"), statement); Region region =
    //        new SleepRegion(statement); Statement timedStatement = new
    //        TimedStatement(region.getRegionID(), statement);
    //        statementBlock.add(timedStatement);
    //        Regions.addRegion(region);
    //
  ...
  //        + "program1"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  //
  //        double performance = 3;
  //        Set<String> configuration = new HashSet<>();
  //        Assert.assertEquals(performance,
  //        performanceModel.evaluate(configuration), 0);
  //
  //        performance = 6;
  //        configuration = new HashSet<>();
  //        configuration.add("A");
  ...
  //        String program =
  //        edu.cmu.cs.mvelezce.sleep.Helper.loadFile(TimedSleepInterpreterTest.PROGRAMS_PATH
  //        + "program16"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  ...
  //        String program =
  //        edu.cmu.cs.mvelezce.sleep.Helper.loadFile(TimedSleepInterpreterTest.PROGRAMS_PATH
  //        + "program12"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  ////        System.out.println(performanceModel);
  //
  ...
  //        String program =
  //        edu.cmu.cs.mvelezce.sleep.Helper.loadFile(TimedSleepInterpreterTest.PROGRAMS_PATH
  //        + "program13"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  //
  //        double performance = 2;
  //        Set<String> configuration = new HashSet<>();
  ...
  //        String program =
  //        edu.cmu.cs.mvelezce.sleep.Helper.loadFile(TimedSleepInterpreterTest.PROGRAMS_PATH
  //        + "program14"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  //
  ...
  //        String program =
  //        edu.cmu.cs.mvelezce.sleep.Helper.loadFile(TimedSleepInterpreterTest.PROGRAMS_PATH
  //        + "program15"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  //
  //        double performance = 2;
  //        Set<String> configuration = new HashSet<>();
  ...
  //        String program =
  //        edu.cmu.cs.mvelezce.sleep.Helper.loadFile(TimedSleepInterpreterTest.PROGRAMS_PATH
  //        + "program3"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  //
  //        double performance = 6;
  //        Set<String> configuration = new HashSet<>();
  ...
  //        String program =
  //        edu.cmu.cs.mvelezce.sleep.Helper.loadFile(TimedSleepInterpreterTest.PROGRAMS_PATH
  //        + "program4"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  //
  //        double performance = 6;
  //        Set<String> configuration = new HashSet<>();
  ...
  //        String program =
  //        edu.cmu.cs.mvelezce.sleep.Helper.loadFile(TimedSleepInterpreterTest.PROGRAMS_PATH
  //        + "program5"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  ////        System.out.println(performanceModel);
  //
  //        double performance = 0;
  ...
  //        String program =
  //        edu.cmu.cs.mvelezce.sleep.Helper.loadFile(TimedSleepInterpreterTest.PROGRAMS_PATH
  //        + "program6"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  ////        System.out.println(performanceModel);
  //
  //        double performance = 0;
  ...
  //        String program =
  //        edu.cmu.cs.mvelezce.sleep.Helper.loadFile(TimedSleepInterpreterTest.PROGRAMS_PATH
  //        + "program7"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  //
  //        double performance = 0;
  //        Set<String> configuration = new HashSet<>();
  ...
  //        String program =
  //        edu.cmu.cs.mvelezce.sleep.Helper.loadFile(TimedSleepInterpreterTest.PROGRAMS_PATH
  //        + "program8"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  ////        System.out.println(performanceModel);
  //
  //        double performance = 0;
  ...
  //        String program =
  //        edu.cmu.cs.mvelezce.sleep.Helper.loadFile(TimedSleepInterpreterTest.PROGRAMS_PATH
  //        + "program9"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  //
  //        double performance = 0;
  //        Set<String> configuration = new HashSet<>();
  ...
  //        String program =
  //        edu.cmu.cs.mvelezce.sleep.Helper.loadFile(TimedSleepInterpreterTest.PROGRAMS_PATH
  //        + "program10"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  //
  //        double performance = 0;
  //        Set<String> configuration = new HashSet<>();
  ...
  //        String program =
  //        edu.cmu.cs.mvelezce.sleep.Helper.loadFile(TimedSleepInterpreterTest.PROGRAMS_PATH
  //        + "program17"); PerformanceModel performanceModel =
  //        SleepPipeline.buildPerformanceModel(program);
  //        System.out.println(performanceModel);
  //
  //        double performance = 2;
